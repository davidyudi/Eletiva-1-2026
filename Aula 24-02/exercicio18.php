...
<body>
    <div class="container py-3">
        ...
        <form method="post">
            ...
            <div class="mb-3">
                <label for="taxa" class="form-label">Informe taxa de juros</label>
                <input type="number" id="taxa" name="taxa" class="form-control" required="">
            </div>
            <div class="mb-3">
                <label for="periodo" class="form-label">Informe taxa de período (meses)</label>
        ...
        <?php
            if($_SERVER['REQUEST_METHOD'] == "POST"){
                ...
                $res = $capital * ((1 + ($taxa / 100)) ** $periodo);
