...
INSERT INTO `estados` (`id`, `sigla`) VALUES
(1, 'AC'),
(2, 'AL'),
(4, 'AM'),
(3, 'AP'),
...
(1, 'adm', 'admin@email.com', '$2y$10$pt5hx1LzKklLOlv03CLzXOBqz4ZhIr/2hr2ck80ME3rS8dwrixALG');
...
--
ALTER TABLE `viagens`
  ADD CONSTRAINT `fk_Viagens_Motoristas1` FOREIGN KEY (`Motoristas_id`) REFERENCES `motoristas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
